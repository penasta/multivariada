...
estudo através da transformação de Mahalanobis ($\mathbf{Z}=\mathbf{XD}^{-1/2}$), em que **S** é a matriz de variância-covariâncias amostrais. Seria razoável aplicar componentes principais nos dados transformados? Justifique sua resposta.
...
fviz_pca_biplot(teste, repel = TRUE,
